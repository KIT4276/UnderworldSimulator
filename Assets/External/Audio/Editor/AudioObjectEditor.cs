...
public class AudioObjectEditor : Editor
{
    ...
    private bool ShowSoundEditor(Sound sound)
    {
        ...
        if (GUILayout.Button("x", GUILayout.Width(30))) return false;
        ...
        sound.MixerGroup = EditorGUILayout.ObjectField("Mixer Group", sound.MixerGroup, typeof(AudioMixerGroup), false) as AudioMixerGroup;
