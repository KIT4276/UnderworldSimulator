...
public class InventorySystem : MonoBehaviour
{
    ...
    public void TryReturnLootToInventory(Item loot) /// �����������! ���� ���������� ������ ����� ������� ���
    {
    ...
    public void TryReturnDecorToInventory(Decor decor)//�����������! ���� ����������, ������ ���� ����� ������� �����.
    {
    ...
    private void ReturnLootToInventory(Item loot, int i)//�����������! ���� ����������, ������ ���� ����� ������� ���.
    {
    ...
    private bool FindPlaceForItem(IBaseItem item)
    {
        ...
        {
            if (!slot.IsOccupied || (slot.IsOccupied && slot.Items[0].GetIcon() == item.GetIcon()))// ��������� ���� ���
            {
